...
namespace TermSAT.Formulas
{
     ...
     *
     */
    public class InstanceRecognizer : TrieMap<IFormulaSequence, Formula, Formula>
    {
        ...
        public class RecognizerVisitor : IVisitor<List<SearchResult>>
        {
            ...
            public bool Visit(TrieMap<IFormulaSequence, Formula, Formula>.INode node)
            {
                ...
                try
                {
                    ...
                    else if (currentSubformula != null)
                    {
                        ...
                        if (!currentSubformula.GetType().Equals(instanceSubformula.GetType()))
                            return false;
            ...
            public void Leave(TrieMap<IFormulaSequence, Formula, Formula>.INode node)
            {
                _substitutions.Pop();
                _position.Pop();
            }
