...
public class RuleCompletionGenerator {
	...
	private ArrayList<ReductionRule> _rules= new ArrayList<ReductionRule>();
	...
	public void run() {
		...
		try {
			...
			nonCanonicalFormulas.close();

			CompletionGenerator1 generator= new CompletionGenerator1(_rules);
