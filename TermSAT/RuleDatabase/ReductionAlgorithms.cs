...
namespace TermSAT.RuleDatabase
{
    ...
    public static class ReductionAlgorithms
    {
        ...
        /// if replacing all occurrences of formula C in the consequent with either T or F makes the entire 
        /// consequent true (and hence, makes the original formula true) then 
        /// replace all occurrences of C that appear in the original formula's antecedent with the opposite 
        /// value. For instance, if replacing C with T makes a consequent true then replace all occurrences 
        ...
        /// if replacing all occurrence of formula C in the antecedent with either T or F makes the entire 
        /// antecedent false (and hence, makes the original formula true) then 
        /// replace all occurrences of C that appear in the original formula's consequent with the opposite 
        /// value. For instance, if replacing C with T makes the antecedent false then replace all occurrences 
        ...
        /// is.  
        /// That's because the set of rules generated by the RuleGenerator is finite while the single 
        ...
        /// Perhaps at some point I'll be able to show that a finite set of 'algorithmic rules' is sufficient 
        /// to solve SAT problems.
        /// 
        /// </summary>
        /// <returns>A reduced formula, or the original formula if the original formula cannot be reduced.</returns>
        public static bool TryReduceUsingSingleReplacement(Formula formula, out ReplacementReduction reduction)
        {
            ...
            var sequence = formula.AsFlatTerm();
