...
import com.googlecode.termsat.core.Implication;
import com.googlecode.termsat.core.Negation;
import com.googlecode.termsat.core.Variable;
import com.googlecode.termsat.core.utils.ArgUtils;
...
public class Solver {
	...
	public static const Solver FAUX_SOLVER= new Solver() {
		public sealed Formula reduce(Formula formula) {
			return formula;
		};
	};
